...
### What you can do with Launch Flow

* Run flash sales and seasonal promotions (Black Friday, Cyber Monday, holiday sales)
* Schedule coordinated price drops across many products at a precise time
* Publish a redesigned theme or landing page at launch time
* Set time-boxed promotions that revert automatically when they're over

{% hint style="success" %}
**New here?** Start with [Installation & setup](get-started/installation.md), then schedule your first sale in the [Quick start](get-started/quick-start.md).
{% endhint %}
